...
<body>
    ...
    <h2 class="he2">MODULES</h2>
    <H1 class="he1">WELCOME! </H1>

    <p class="p1">Inventory management system is a set of tools and practices
        designed to efficiently track and manage a company's
        inventory, including raw materials, work-in-progress items, and
        finished goods. The purpose of an inventory management
        system is to ensure that a company has the right quantity of
        products on hand at the right time, while minimizing costs
        associated with holding inventory.
    </p>

    <div>
        <ul class="p2">
            <li><a class="tag1" href="{{route('er')}}">E/R Diagram</a></li>
            <li><a class="tag1" href="{{route('ct')}}">Relational Schema</a></li>
            <li><a class="tag1" href="{{route('sc')}}">SQL Code</a></li>
            <li><a class="tag1" href="{{route('pyt')}}">Python Code For Generating Tuples</a></li>
            <li><a class="tag1" href="{{route('index')}}">SQL & DB </a></li>
          {{-- <li><a class="tag1" href="pdp.html">PERL Database Programming</a></li>  --}}
        </ul>
    </div>
